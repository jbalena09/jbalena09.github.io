...
public class Activity8_Tester extends JFrame implements MouseMotionListener{

    static String name = "";
    static Color col = Color.WHITE;
    static JTextField test;

    public Activity8_Tester() {
        super("Activity 8");
...
//        Object col = JOptionPane.showInputDialog(null, "Choose color", "Color Selection", JOptionPane.QUESTION_MESSAGE, null, col1, "Red");
        if (col.equals("Red")) {
            Activity8_Tester.col = Color.RED;
        } else if (col.equals("Blue")) {
            Activity8_Tester.col = Color.BLUE;
        } else if (col.equals("Green")) {
            Activity8_Tester.col = Color.GREEN;
        } else if (col.equals("Yellow")) {
            Activity8_Tester.col = Color.YELLOW;
        } else if (col.equals("White")) {
            Activity8_Tester.col = Color.WHITE;
        }
        setSize(800, 800);
        setVisible(true);
    ...
    public void paint(Graphics g) {
        ...
        g.drawString(name, 330, getWidth() / 2 + 200);;
    ...
    public void mouseMoved(MouseEvent e) {
        test.setText(Integer.toString(e.getX()) + " " + Integer.toString(e.getY()));
    }
}
